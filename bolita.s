...
update_display:
    ...
    # 6. Pequeña pausa para controlar velocidad
    li a0, 30        # 30ms de retardo (ajustable)
    call delay_ms
...
delay_ms:
    li t1, 0
delay_outer:
    li t2, 1      # Ajusta este número según tu procesador/simulador
delay_inner:
    addi t2, t2, -1
    bnez t2, delay_inner
    addi t1, t1, 1
    blt t1, a0, delay_outer
    ret
